...
public class EliminarCategoria extends javax.swing.JFrame {
    ...
    public EliminarCategoria() {
        initComponents();
        this.setTitle("Eliminar Categoría "); // Cambia el título de la ventana
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese el ID de categoria");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 70, -1, -1));

        jLabel3.setForeground(new java.awt.Color(255, 51, 51));
        jLabel3.setText("Nota: para eliminar una categoria primero revise que no esté asignada a una obra");
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        try {
            ...
            if (rowsAffected > 0) {
                ...
                javax.swing.JOptionPane.showMessageDialog(this, "No se encontró una categoría con el ID especificado.");
            }
            ...
            // Manejar el error
            e.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this, "Error al eliminar la categoría: " + e.getMessage());
        }
