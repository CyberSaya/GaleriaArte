...
public class EliminarExposicion extends javax.swing.JFrame {

    /**
     * Creates new form Obras
     */
    public EliminarExposicion() {
        initComponents();
        this.setTitle("Eliminar Exposición "); // Cambia el título de la ventana
    ...
    private void btn_eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_eliminarActionPerformed
        ...
        try {
            ...
            String sql = "DELETE FROM Exposicion WHERE id_exposicion = ?";
            ...
            if (rowsAffected > 0) {
                javax.swing.JOptionPane.showMessageDialog(this, "Exposicion eliminada correctamente.");
            } else {
                javax.swing.JOptionPane.showMessageDialog(this, "No se encontró una exposicion con el ID especificado.");
            }
            ...
            // Manejar el error
            e.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this, "Error al eliminar la exposicion: " + e.getMessage());
        }
